...
MIGRATIONS = (
    ...
    Migration(
        version=4,
        name="gate4_data_commands",
        statements=(
            """
            CREATE TABLE host_commands_v4 (
                command_id TEXT PRIMARY KEY,
                agent_id TEXT NOT NULL REFERENCES host_agents(agent_id) ON DELETE RESTRICT,
                run_id TEXT NOT NULL,
                operation_id TEXT NOT NULL,
            ...
            """,
            """
            INSERT INTO host_commands_v4 SELECT * FROM host_commands
            """,
            "DROP TABLE host_commands",
            "ALTER TABLE host_commands_v4 RENAME TO host_commands",
            """
            CREATE INDEX ix_host_commands_delivery
            ON host_commands(agent_id, state, created_at)
            """,
