...
live acceptanceまで完了しています。Gate 4はR2 temporary credential、Server Unit専用restic repository、
明示snapshot restore、Snapshot commit後のLinode削除を実装し、自動testを通過して実accountのlive
acceptance待ちです。
