...
- Control Plane、Host API、reconcilerのsystem service packaging
- Discord Bot adapter
...
5. 通常CLIで実account lifecycleを一周し、Operational MVPを判定する。
6. system service packaging、外部playability、VM reboot recovery、Discord adapter、
   定期snapshotの優先順位を改めて決める。
