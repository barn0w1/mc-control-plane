...
| [0011](0011-critical-failure-and-cost-controller.md) | Superseded | Critical failureからのforced deletionをCost controllerへ分離する |
| [0012](0012-fatal-incidents.md) | Accepted | 予測不能な外部failureをFatal Incidentとして記録する |
