...
5. fresh Linodeへの再restoreまでend-to-endで確認する。（Gate 4 fixtureでlive acceptance完了）
...
acceptanceまで完了しています。実地で発見した基盤問題を修正したcheckpointを維持し、次の計画を
決めるまでMinecraft lifecycleへは進みません。中期目標全体の
