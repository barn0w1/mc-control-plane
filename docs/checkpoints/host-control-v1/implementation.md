...
- terminal cleanupをHostControllerから分離

Compatibility migrationは提供しません。

## Next implementation sequence

### Slice 1: Akamai-native local model
...
### Slice 5: Idle reuse and CostController

- release/idle state
- compatibility rule
- sanitization
- retention policy
- CostController eligibility and disposal
- Critical alert surface
